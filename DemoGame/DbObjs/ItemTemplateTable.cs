...
/// The underlying database type is `varchar(255)` with the default value of ` `.The database column contains the comment: 
...
/// The underlying database type is `smallint(5) unsigned`.The database column contains the comment: 
/// "The unique ID of the item template.".
/// </summary>
[System.ComponentModel.Description("The unique ID of the item template.")]
[NetGore.SyncValueAttribute()]
...
/// The underlying database type is `varchar(255)` with the default value of `New item template`.The database column contains the comment: 
...
/// The underlying database type is `smallint(5) unsigned` with the default value of `10`.The database column contains the comment: 
...
/// </returns>
public virtual IItemTemplateTable DeepCopy()
{
...
case "description":
return new ColumnMetadata("description", "The item's textual description (don't include stuff like stats).", "varchar(255)", " ", typeof(System.String), false, false, false);
...
case "id":
return new ColumnMetadata("id", "The unique ID of the item template.", "smallint(5) unsigned", null, typeof(System.UInt16), false, true, false);
...
case "name":
return new ColumnMetadata("name", "The name of the item.", "varchar(255)", "New item template", typeof(System.String), false, false, false);
...
case "weapon_type":
return new ColumnMetadata("weapon_type", "When used as a weapon, the type of weapon (see WeaponType enum).", "tinyint(3) unsigned", "0", typeof(System.Byte), false, false, false);
