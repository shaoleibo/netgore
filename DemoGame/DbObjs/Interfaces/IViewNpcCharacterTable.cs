...
{
/// <summary>
/// Interface for a class that can be used to serialize values to the database table `view_npc_character`.
/// </summary>
public interface IViewNpcCharacterTable
{
/// <summary>
...
/// </returns>
IViewNpcCharacterTable DeepCopy();
