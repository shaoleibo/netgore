...
{
/// <summary>
/// Interface for a class that can be used to serialize values to the database table `world_stats_count_shop_buy`.
/// </summary>
public interface IWorldStatsCountShopBuyTable
{
/// <summary>
...
/// </returns>
IWorldStatsCountShopBuyTable DeepCopy();
