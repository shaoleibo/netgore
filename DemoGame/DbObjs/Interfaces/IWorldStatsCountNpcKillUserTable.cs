...
{
/// <summary>
/// Interface for a class that can be used to serialize values to the database table `world_stats_count_npc_kill_user`.
/// </summary>
public interface IWorldStatsCountNpcKillUserTable
{
/// <summary>
...
/// </returns>
IWorldStatsCountNpcKillUserTable DeepCopy();
