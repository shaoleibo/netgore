...
{
/// <summary>
/// Interface for a class that can be used to serialize values to the database table `world_stats_count_item_create`.
/// </summary>
public interface IWorldStatsCountItemCreateTable
{
/// <summary>
...
/// </returns>
IWorldStatsCountItemCreateTable DeepCopy();
