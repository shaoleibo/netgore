...
{
/// <summary>
/// Interface for a class that can be used to serialize values to the database table `world_stats_count_consume_item`.
/// </summary>
public interface IWorldStatsCountConsumeItemTable
{
/// <summary>
...
/// </returns>
IWorldStatsCountConsumeItemTable DeepCopy();
