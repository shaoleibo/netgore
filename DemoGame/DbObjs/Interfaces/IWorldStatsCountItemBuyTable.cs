...
{
/// <summary>
/// Interface for a class that can be used to serialize values to the database table `world_stats_count_item_buy`.
/// </summary>
public interface IWorldStatsCountItemBuyTable
{
/// <summary>
...
/// </returns>
IWorldStatsCountItemBuyTable DeepCopy();
