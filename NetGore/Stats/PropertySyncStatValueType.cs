...
{
    /// <summary>
    /// Implementation of a <see cref="PropertySyncBase{T}"/> that handles synchronizing a <see cref="StatValueType"/>.
    /// </summary>
    [PropertySyncHandler(typeof(StatValueType))]
    public sealed class PropertySyncStatValueType : PropertySyncBase<StatValueType>
    {
        /// <summary>
        ...
        protected override StatValueType Read(string name, IValueReader reader)
        {
            return reader.ReadStatValueType(name);
        }
