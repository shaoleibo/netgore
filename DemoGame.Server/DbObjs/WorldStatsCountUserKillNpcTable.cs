...
/// </summary>
public class WorldStatsCountUserKillNpcTable : IWorldStatsCountUserKillNpcTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
public const System.String TableName = "world_stats_count_user_kill_npc";
/// <summary>
...
/// </summary>
[System.ComponentModel.Description("Total number of NPCs killed by this user.")]
...
/// "The character template that this NPC kill counter is for.".
/// </summary>
[System.ComponentModel.Description("The character template that this NPC kill counter is for.")]
[NetGore.SyncValueAttribute()]
...
/// </summary>
[System.ComponentModel.Description("The user that this kill counter is for.")]
[NetGore.SyncValueAttribute()]
...
/// <param name="dic">The Dictionary to copy the values into.</param>
public static void CopyValues(IWorldStatsCountUserKillNpcTable source, System.Collections.Generic.IDictionary<System.String,System.Object> dic)
{
...
{
case "count":
return new ColumnMetadata("count", "Total number of NPCs killed by this user.", "int(11)", "0", typeof(System.Int32), false, false, false);
...
case "npc_template_id":
return new ColumnMetadata("npc_template_id", "The character template that this NPC kill counter is for.", "smallint(5) unsigned", null, typeof(System.UInt16), false, true, false);

case "user_id":
return new ColumnMetadata("user_id", "The user that this kill counter is for.", "int(11)", null, typeof(System.Int32), false, true, false);
