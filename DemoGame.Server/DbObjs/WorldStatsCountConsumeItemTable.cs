...
{
/// <summary>
/// Provides a strongly-typed structure for the database table `world_stats_count_consume_item`.
/// </summary>
public class WorldStatsCountConsumeItemTable : IWorldStatsCountConsumeItemTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
public const System.String TableName = "world_stats_count_consume_item";
/// <summary>
...
/// "Number of times items of this template have been consumed.".
/// </summary>
[System.ComponentModel.Description("Number of times items of this template have been consumed.")]
...
/// </summary>
[System.ComponentModel.Description("The item template the counter is for.")]
[NetGore.SyncValueAttribute()]
...
/// </returns>
public virtual IWorldStatsCountConsumeItemTable DeepCopy()
{
return new WorldStatsCountConsumeItemTable(this);
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsCountConsumeItemTable"/> class.
/// </summary>
public WorldStatsCountConsumeItemTable()
{
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsCountConsumeItemTable"/> class.
...
public WorldStatsCountConsumeItemTable(System.Int32 @count, DemoGame.ItemTemplateID @itemTemplateID, System.DateTime @lastUpdate)
{
...
/// Initializes a new instance of the <see cref="WorldStatsCountConsumeItemTable"/> class.
/// </summary>
/// <param name="source">IWorldStatsCountConsumeItemTable to copy the initial values from.</param>
public WorldStatsCountConsumeItemTable(IWorldStatsCountConsumeItemTable source)
{
...
/// <param name="dic">The Dictionary to copy the values into.</param>
public static void CopyValues(IWorldStatsCountConsumeItemTable source, System.Collections.Generic.IDictionary<System.String,System.Object> dic)
{
...
/// <summary>
/// Copies the values from the given <paramref name="source"/> into this WorldStatsCountConsumeItemTable.
/// </summary>
/// <param name="source">The IWorldStatsCountConsumeItemTable to copy the values from.</param>
public void CopyValuesFrom(IWorldStatsCountConsumeItemTable source)
{
...
{
case "count":
return new ColumnMetadata("count", "Number of times items of this template have been consumed.", "int(11)", "0", typeof(System.Int32), false, false, false);

case "item_template_id":
return new ColumnMetadata("item_template_id", "The item template the counter is for.", "smallint(5) unsigned", null, typeof(System.UInt16), false, true, false);
