...
{
/// <summary>
/// Provides a strongly-typed structure for the database table `world_stats_count_item_sell`.
/// </summary>
public class WorldStatsCountItemSellTable : IWorldStatsCountItemSellTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
public const System.String TableName = "world_stats_count_item_sell";
/// <summary>
...
/// "Amount of this item template that has been sold to stores.".
/// </summary>
[System.ComponentModel.Description("Amount of this item template that has been sold to stores.")]
...
/// </returns>
public virtual IWorldStatsCountItemSellTable DeepCopy()
{
return new WorldStatsCountItemSellTable(this);
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsCountItemSellTable"/> class.
/// </summary>
public WorldStatsCountItemSellTable()
{
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsCountItemSellTable"/> class.
...
public WorldStatsCountItemSellTable(System.Int32 @count, DemoGame.ItemTemplateID @itemTemplateID, System.DateTime @lastUpdate)
{
...
{
case "count":
return new ColumnMetadata("count", "Amount of this item template that has been sold to stores.", "int(11)", "0", typeof(System.Int32), false, false, false);
