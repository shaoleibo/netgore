...
{
/// <summary>
/// Provides a strongly-typed structure for the database table `quest_require_start_item`.
/// </summary>
public class QuestRequireStartItemTable : IQuestRequireStartItemTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
public const System.String TableName = "quest_require_start_item";
/// <summary>
...
/// </summary>
[System.ComponentModel.Description("The amount of the item that is required.")]
...
/// "The template of the item that is required to start the quest.".
/// </summary>
[System.ComponentModel.Description("The template of the item that is required to start the quest.")]
[NetGore.SyncValueAttribute()]
...
/// </summary>
[System.ComponentModel.Description("Quest that this requirement is for.")]
[NetGore.SyncValueAttribute()]
...
/// </returns>
public virtual IQuestRequireStartItemTable DeepCopy()
{
return new QuestRequireStartItemTable(this);
}
/// <summary>
/// Initializes a new instance of the <see cref="QuestRequireStartItemTable"/> class.
/// </summary>
public QuestRequireStartItemTable()
{
}
/// <summary>
/// Initializes a new instance of the <see cref="QuestRequireStartItemTable"/> class.
...
public QuestRequireStartItemTable(System.Byte @amount, DemoGame.ItemTemplateID @itemTemplateID, NetGore.Features.Quests.QuestID @questID)
{
...
/// Initializes a new instance of the <see cref="QuestRequireStartItemTable"/> class.
/// </summary>
/// <param name="source">IQuestRequireStartItemTable to copy the initial values from.</param>
public QuestRequireStartItemTable(IQuestRequireStartItemTable source)
{
...
/// <param name="dic">The Dictionary to copy the values into.</param>
public static void CopyValues(IQuestRequireStartItemTable source, System.Collections.Generic.IDictionary<System.String,System.Object> dic)
{
...
/// <summary>
/// Copies the values from the given <paramref name="source"/> into this QuestRequireStartItemTable.
/// </summary>
/// <param name="source">The IQuestRequireStartItemTable to copy the values from.</param>
public void CopyValuesFrom(IQuestRequireStartItemTable source)
{
...
{
case "amount":
return new ColumnMetadata("amount", "The amount of the item that is required.", "tinyint(3) unsigned", null, typeof(System.Byte), false, false, false);

case "item_template_id":
return new ColumnMetadata("item_template_id", "The template of the item that is required to start the quest.", "smallint(5) unsigned", null, typeof(System.UInt16), false, true, false);

case "quest_id":
return new ColumnMetadata("quest_id", "Quest that this requirement is for.", "smallint(5) unsigned", null, typeof(System.UInt16), false, true, false);
