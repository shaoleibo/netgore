...
{
/// <summary>
/// Provides a strongly-typed structure for the database table `world_stats_user_kill_npc`.
/// </summary>
public class WorldStatsUserKillNpcTable : IWorldStatsUserKillNpcTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
public const System.String TableName = "world_stats_user_kill_npc";
/// <summary>
...
/// </returns>
public virtual IWorldStatsUserKillNpcTable DeepCopy()
{
return new WorldStatsUserKillNpcTable(this);
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsUserKillNpcTable"/> class.
/// </summary>
public WorldStatsUserKillNpcTable()
{
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsUserKillNpcTable"/> class.
...
case "user_x":
return new ColumnMetadata("user_x", "The map x coordinate of the user when this event took place. Only valid when the map_id is not null.", "smallint(5) unsigned", null, typeof(System.UInt16), false, false, false);

case "user_y":
return new ColumnMetadata("user_y", "The map y coordinate of the user when this event took place. Only valid when the map_id is not null.", "smallint(5) unsigned", null, typeof(System.UInt16), false, false, false);
