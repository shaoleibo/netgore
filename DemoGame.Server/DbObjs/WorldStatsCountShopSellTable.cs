...
{
/// <summary>
/// Provides a strongly-typed structure for the database table `world_stats_count_shop_sell`.
/// </summary>
public class WorldStatsCountShopSellTable : IWorldStatsCountShopSellTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
public const System.String TableName = "world_stats_count_shop_sell";
/// <summary>
...
/// "The number of times this shop has purchased items (shopper has sold to this shop).".
/// </summary>
[System.ComponentModel.Description("The number of times this shop has purchased items (shopper has sold to this shop).")]
...
/// </returns>
public virtual IWorldStatsCountShopSellTable DeepCopy()
{
return new WorldStatsCountShopSellTable(this);
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsCountShopSellTable"/> class.
/// </summary>
public WorldStatsCountShopSellTable()
{
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsCountShopSellTable"/> class.
...
/// Initializes a new instance of the <see cref="WorldStatsCountShopSellTable"/> class.
/// </summary>
/// <param name="source">IWorldStatsCountShopSellTable to copy the initial values from.</param>
public WorldStatsCountShopSellTable(IWorldStatsCountShopSellTable source)
{
...
/// <param name="dic">The Dictionary to copy the values into.</param>
public static void CopyValues(IWorldStatsCountShopSellTable source, System.Collections.Generic.IDictionary<System.String,System.Object> dic)
{
...
{
case "count":
return new ColumnMetadata("count", "The number of times this shop has purchased items (shopper has sold to this shop).", "int(11)", "0", typeof(System.Int32), false, false, false);
