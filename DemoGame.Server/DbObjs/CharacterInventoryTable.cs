...
/// </summary>
public class CharacterInventoryTable : ICharacterInventoryTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
[System.ComponentModel.Description("The character who has this item in their inventory.")]
...
/// </summary>
[System.ComponentModel.Description("The item that is in the character's inventory.")]
[NetGore.SyncValueAttribute()]
...
/// "The slot the item is in in the character's inventory.".
/// </summary>
[System.ComponentModel.Description("The slot the item is in in the character's inventory.")]
[NetGore.SyncValueAttribute()]
public NetGore.InventorySlot Slot
{
get
{
return (NetGore.InventorySlot)_slot;
}
set
{
...
/// </returns>
public virtual ICharacterInventoryTable DeepCopy()
{
...
dic["slot"] = (NetGore.InventorySlot)source.Slot;
}
...
this.Slot = (NetGore.InventorySlot)source.Slot;
}
...
case "slot":
this.Slot = (NetGore.InventorySlot)value;
break;
...
{
case "character_id":
return new ColumnMetadata("character_id", "The character who has this item in their inventory.", "int(11)", null, typeof(System.Int32), false, true, false);

case "item_id":
return new ColumnMetadata("item_id", "The item that is in the character's inventory.", "int(11)", null, typeof(System.Int32), false, false, true);

case "slot":
return new ColumnMetadata("slot", "The slot the item is in in the character's inventory.", "tinyint(3) unsigned", null, typeof(System.Byte), false, true, false);
