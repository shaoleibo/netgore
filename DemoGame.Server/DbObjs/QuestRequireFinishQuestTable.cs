...
/// </summary>
public class QuestRequireFinishQuestTable : IQuestRequireFinishQuestTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
public const System.String TableName = "quest_require_finish_quest";
/// <summary>
...
/// </summary>
[System.ComponentModel.Description("The quest required to be finished before this quest can be finished.")]
[NetGore.SyncValueAttribute()]
...
public QuestRequireFinishQuestTable(NetGore.Features.Quests.QuestID @questID, NetGore.Features.Quests.QuestID @reqQuestID)
{
...
case "req_quest_id":
return new ColumnMetadata("req_quest_id", "The quest required to be finished before this quest can be finished.", "smallint(5) unsigned", null, typeof(System.UInt16), false, true, false);
