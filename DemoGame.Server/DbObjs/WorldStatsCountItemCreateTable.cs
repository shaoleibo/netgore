...
{
/// <summary>
/// Provides a strongly-typed structure for the database table `world_stats_count_item_create`.
/// </summary>
public class WorldStatsCountItemCreateTable : IWorldStatsCountItemCreateTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
public const System.String TableName = "world_stats_count_item_create";
/// <summary>
...
/// "The total number of times this item has been instantiated. When instantiating multiple items at once, this is incremented by the amount of the item, not just one.".
/// </summary>
[System.ComponentModel.Description("The total number of times this item has been instantiated. When instantiating multiple items at once, this is incremented by the amount of the item, not just one.")]
...
/// </summary>
[System.ComponentModel.Description("The item template this counter is for.")]
[NetGore.SyncValueAttribute()]
...
/// </returns>
public virtual IWorldStatsCountItemCreateTable DeepCopy()
{
return new WorldStatsCountItemCreateTable(this);
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsCountItemCreateTable"/> class.
/// </summary>
public WorldStatsCountItemCreateTable()
{
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsCountItemCreateTable"/> class.
...
/// Initializes a new instance of the <see cref="WorldStatsCountItemCreateTable"/> class.
/// </summary>
/// <param name="source">IWorldStatsCountItemCreateTable to copy the initial values from.</param>
public WorldStatsCountItemCreateTable(IWorldStatsCountItemCreateTable source)
{
...
/// <param name="dic">The Dictionary to copy the values into.</param>
public static void CopyValues(IWorldStatsCountItemCreateTable source, System.Collections.Generic.IDictionary<System.String,System.Object> dic)
{
...
/// <summary>
/// Copies the values from the given <paramref name="source"/> into this WorldStatsCountItemCreateTable.
/// </summary>
/// <param name="source">The IWorldStatsCountItemCreateTable to copy the values from.</param>
public void CopyValuesFrom(IWorldStatsCountItemCreateTable source)
{
...
{
case "count":
return new ColumnMetadata("count", "The total number of times this item has been instantiated. When instantiating multiple items at once, this is incremented by the amount of the item, not just one.", "int(11)", "0", typeof(System.Int32), false, false, false);

case "item_template_id":
return new ColumnMetadata("item_template_id", "The item template this counter is for.", "smallint(5) unsigned", null, typeof(System.UInt16), false, true, false);
