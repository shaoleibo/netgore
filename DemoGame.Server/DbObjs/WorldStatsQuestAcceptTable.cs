...
{
/// <summary>
/// Provides a strongly-typed structure for the database table `world_stats_quest_accept`.
/// </summary>
public class WorldStatsQuestAcceptTable : IWorldStatsQuestAcceptTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
public const System.String TableName = "world_stats_quest_accept";
/// <summary>
...
/// </summary>
[System.ComponentModel.Description("The quest that was accepted.")]
[NetGore.SyncValueAttribute()]
...
/// </summary>
[System.ComponentModel.Description("The ID of the user that accepted the quest.")]
[NetGore.SyncValueAttribute()]
...
/// </returns>
public virtual IWorldStatsQuestAcceptTable DeepCopy()
{
return new WorldStatsQuestAcceptTable(this);
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsQuestAcceptTable"/> class.
/// </summary>
public WorldStatsQuestAcceptTable()
{
}
/// <summary>
/// Initializes a new instance of the <see cref="WorldStatsQuestAcceptTable"/> class.
...
case "quest_id":
return new ColumnMetadata("quest_id", "The quest that was accepted.", "smallint(5) unsigned", null, typeof(System.UInt16), false, false, true);

case "user_id":
return new ColumnMetadata("user_id", "The ID of the user that accepted the quest.", "int(11)", null, typeof(System.Int32), false, false, true);
