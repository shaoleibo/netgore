...
{
/// <summary>
/// Contains extension methods for class WorldStatsQuestCompleteTable that assist in performing
/// reads and writes to and from a database.
/// </summary>
public static  class WorldStatsQuestCompleteTableDbExtensions
{
/// <summary>
...
public static void CopyValues(this IWorldStatsQuestCompleteTable source, NetGore.Db.DbParameterValues paramValues)
{
...
/// <summary>
/// Checks if this <see cref="IWorldStatsQuestCompleteTable"/> contains the same values as another <see cref="IWorldStatsQuestCompleteTable"/>.
/// </summary>
/// <param name="source">The source <see cref="IWorldStatsQuestCompleteTable"/>.</param>
/// <param name="otherItem">The <see cref="IWorldStatsQuestCompleteTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="IWorldStatsQuestCompleteTable"/> contains the same values as the <paramref name="otherItem"/>; otherwise false.
/// </returns>
public static System.Boolean HasSameValues(this IWorldStatsQuestCompleteTable source, IWorldStatsQuestCompleteTable otherItem)
{
