...
public static void CopyValues(this ICharacterTemplateQuestProviderTable source, NetGore.Db.DbParameterValues paramValues)
{
...
public static void TryReadValues(this CharacterTemplateQuestProviderTable source, System.Data.IDataRecord dataRecord)
{
...
/// <param name="source">The object to copy the values from.</param>
/// <param name="paramValues">The DbParameterValues to copy the values into.</param>
public static void TryCopyValues(this ICharacterTemplateQuestProviderTable source, NetGore.Db.DbParameterValues paramValues)
{
...
/// </returns>
public static System.Boolean HasSameValues(this ICharacterTemplateQuestProviderTable source, ICharacterTemplateQuestProviderTable otherItem)
{
