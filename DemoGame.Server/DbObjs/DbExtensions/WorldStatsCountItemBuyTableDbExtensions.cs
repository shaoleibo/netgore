...
public static void CopyValues(this IWorldStatsCountItemBuyTable source, NetGore.Db.DbParameterValues paramValues)
{
...
/// <param name="source">The object to copy the values from.</param>
/// <param name="paramValues">The DbParameterValues to copy the values into.</param>
public static void TryCopyValues(this IWorldStatsCountItemBuyTable source, NetGore.Db.DbParameterValues paramValues)
{
...
/// </returns>
public static System.Boolean HasSameValues(this IWorldStatsCountItemBuyTable source, IWorldStatsCountItemBuyTable otherItem)
{
