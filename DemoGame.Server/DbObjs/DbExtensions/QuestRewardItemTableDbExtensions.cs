...
public static void ReadValues(this QuestRewardItemTable source, System.Data.IDataRecord dataRecord)
{
System.Int32 i;
...
public static void TryReadValues(this QuestRewardItemTable source, System.Data.IDataRecord dataRecord)
{
...
/// <summary>
/// Checks if this <see cref="IQuestRewardItemTable"/> contains the same values as another <see cref="IQuestRewardItemTable"/>.
/// </summary>
/// <param name="source">The source <see cref="IQuestRewardItemTable"/>.</param>
/// <param name="otherItem">The <see cref="IQuestRewardItemTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="IQuestRewardItemTable"/> contains the same values as the <paramref name="otherItem"/>; otherwise false.
/// </returns>
public static System.Boolean HasSameValues(this IQuestRewardItemTable source, IQuestRewardItemTable otherItem)
{
