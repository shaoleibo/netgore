...
{
/// <summary>
/// Contains extension methods for class ViewUserCharacterTable that assist in performing
/// reads and writes to and from a database.
/// </summary>
public static  class ViewUserCharacterTableDbExtensions
{
/// <summary>
...
public static void ReadValues(this ViewUserCharacterTable source, System.Data.IDataRecord dataRecord)
{
System.Int32 i;
...
public static void TryReadValues(this ViewUserCharacterTable source, System.Data.IDataRecord dataRecord)
{
...
/// <summary>
/// Checks if this <see cref="IViewUserCharacterTable"/> contains the same values as another <see cref="IViewUserCharacterTable"/>.
/// </summary>
/// <param name="source">The source <see cref="IViewUserCharacterTable"/>.</param>
/// <param name="otherItem">The <see cref="IViewUserCharacterTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="IViewUserCharacterTable"/> contains the same values as the <paramref name="otherItem"/>; otherwise false.
/// </returns>
public static System.Boolean HasSameValues(this IViewUserCharacterTable source, IViewUserCharacterTable otherItem)
{
