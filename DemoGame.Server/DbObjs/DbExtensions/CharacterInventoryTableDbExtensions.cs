...
/// <summary>
/// Checks if this <see cref="ICharacterInventoryTable"/> contains the same values as another <see cref="ICharacterInventoryTable"/>.
/// </summary>
/// <param name="source">The source <see cref="ICharacterInventoryTable"/>.</param>
/// <param name="otherItem">The <see cref="ICharacterInventoryTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="ICharacterInventoryTable"/> contains the same values as the <paramref name="otherItem"/>; otherwise false.
/// </returns>
public static System.Boolean HasSameValues(this ICharacterInventoryTable source, ICharacterInventoryTable otherItem)
{
