...
public static void TryReadValues(this QuestRequireKillTable source, System.Data.IDataRecord dataRecord)
{
...
/// <summary>
/// Checks if this <see cref="IQuestRequireKillTable"/> contains the same values as another <see cref="IQuestRequireKillTable"/>.
/// </summary>
/// <param name="source">The source <see cref="IQuestRequireKillTable"/>.</param>
/// <param name="otherItem">The <see cref="IQuestRequireKillTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="IQuestRequireKillTable"/> contains the same values as the <paramref name="otherItem"/>; otherwise false.
/// </returns>
public static System.Boolean HasSameValues(this IQuestRequireKillTable source, IQuestRequireKillTable otherItem)
{
