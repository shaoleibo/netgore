...
case "character_template_id":
return new ColumnMetadata("character_template_id", "The template that this character was created from (not required - mostly for developer reference).", "smallint(5) unsigned", null, typeof(System.Nullable<System.UInt16>), true, false, true);
