...
/// </summary>
public class WorldStatsUserLevelTable : IWorldStatsUserLevelTable, NetGore.IO.IPersistable
{
/// <summary>
/// Array of the database column names.
/// </summary>
 static  readonly System.String[] _dbColumns = new string[] {"character_id", "id", "level", "map_id", "when", "x", "y" };
/// <summary>
...
/// </summary>
public const System.String TableName = "world_stats_user_level";
/// <summary>
...
/// </summary>
[System.ComponentModel.Description("The ID of the character that leveled up.")]
...
/// </returns>
public virtual IWorldStatsUserLevelTable DeepCopy()
{
...
{
case "character_id":
return new ColumnMetadata("character_id", "The ID of the character that leveled up.", "int(11)", null, typeof(System.Int32), false, false, false);
